(() => {
  ...
  // extensions/customize-header/src/Extension.js
  function renderExtension({ root }) {
  ...
  // extensions/customize-header/src/Checkout.js
  var Checkout_default = extension("purchase.checkout.header.render-after", (root) => {
    renderExtension({ root });
  });
})();
//# sourceMappingURL=customize-header.js.map
